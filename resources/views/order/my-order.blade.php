                                ...
                                <li>
                                    <div class="order-box">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mt-sm-3 mt-2">
                                            <h6 class="fw-medium dark-text">
                                                <span class="fw-normal content-color">Total:</span>
                                                {{$order->payable}} BDT
                                            </h6>

                                            <div>
                                                @if($order->status == 'Ordered')
                                                    <a id="cancel" data-id="{{$order->id}}" class="btn theme-outline details-btn">Cancel</a>
                                                @endif
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="{{ route('order.delete') }}" onclick="event.preventDefault(); document.getElementById('cancel-form').submit();" class="btn theme-btn mt-0">Confirm</a>

                    <form id="cancel-form" action="{{ route('order.delete') }}" method="POST" class="d-none">
                        @csrf
                        @method('DELETE')
